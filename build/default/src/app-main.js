...
export class AppMain extends LitElement {
  ...
  handleToggleTodoItem(event) {
    this.lists[this.selectedList].todos[event.detail].isDone = !this.lists[this.selectedList].todos[event.detail].isDone;
    ...
    if (this.selectedFilter === FINISH) {
      this.lists[this.selectedList].todos[event.detail].visible = this.lists[this.selectedList].todos[event.detail].isDone;
    }
  ...
  handleDeleteTodoItem(event) {
    this.lists[this.selectedList].todos = this.lists[this.selectedList].todos.filter((item, index) => index !== event.detail);
    this.lists = [...this.lists];
  }
  ...
  handleSelectList(event) {
    ...
    this.lists.forEach(list => {
      list.todos = list.todos.map(todo => ({ ...todo,
        visible: true
      }));
      return list;
    });
